...
public class TalonFXConfigEquality {
    ...
    public static boolean isEqual(MotorOutputConfigs a, MotorOutputConfigs b) {
        boolean val =
            ...
            && MathUtil.isNear(a.PeakForwardDutyCycle, b.PeakForwardDutyCycle,
    ...
    public static boolean isEqual(VoltageConfigs a, VoltageConfigs b) {
        boolean val =
            ...
            && MathUtil.isNear(a.PeakReverseVoltage, b.PeakReverseVoltage,
                               TALON_CONFIG_EPSILON);
        if (ENABLE_LOGGING_INEQ && !val) {
    ...
    public static boolean isEqual(ClosedLoopRampsConfigs a, ClosedLoopRampsConfigs b) {
        boolean val =
            MathUtil.isNear(
                ...
                TALON_CONFIG_EPSILON)
            && MathUtil.isNear(
                a.VoltageClosedLoopRampPeriod, b.VoltageClosedLoopRampPeriod,
                TALON_CONFIG_EPSILON)
            && MathUtil.isNear(
                a.TorqueClosedLoopRampPeriod, b.TorqueClosedLoopRampPeriod,
                TALON_CONFIG_EPSILON);
        if (ENABLE_LOGGING_INEQ && !val) {
    ...
    public static boolean isEqual(MotionMagicConfigs a, MotionMagicConfigs b) {
        boolean val =
            MathUtil.isNear(a.MotionMagicAcceleration, b.MotionMagicAcceleration,
                            TALON_CONFIG_EPSILON)
            && MathUtil.isNear(
